...
const Base: React.FC<PageProps> = props => {
      ...
      description: (
        <FormattedMessage
          ...
          values={{
            GitHub: (
              <a
                href="https://github.com/webclipper/neuron-browser-extension/tree/master/src/common/locales/data"
                target="_blank"
              >
                GitHub
              </a>
  ...
  const configs = useObserver(() => {
    ...
    return originConfigs.concat({
      key: 'update',
      action: (
        <a href="https://github.com/webclipper/neuron-browser-extension/releases" target="_blank">
